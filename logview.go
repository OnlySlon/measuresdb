...
func NewLogView(parent walk.Container) (*LogView, error) {
	...
	if err := walk.InitWidget(
		...
		parent,
		"EDIT",
		win.WS_TABSTOP|win.WS_VISIBLE|win.WS_VSCROLL|win.ES_MULTILINE|win.ES_AUTOHSCROLL,
...
func (*LogView) LayoutFlags() walk.LayoutFlags {
	...
	return walk.ShrinkableHorz | walk.ShrinkableVert | walk.GrowableHorz | walk.GreedyHorz | walk.GreedyVert
}

func (*LogView) MinSizeHint() walk.Size {
	return walk.Size{20, 120}
}

func (*LogView) SizeHint() walk.Size {
	return walk.Size{50, 120}
}
